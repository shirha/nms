...
for dir in ['expeditions\\expeditions6 redux']: #['normal\\normal8 orbital']: #['expeditions\\expeditions6 redux']: #['normal\\playground']: #["expeditions\\expeditions5 exobiology"]: #["normal\\frontiers1"]: #['normal\\playground']: #dirs: #filter(lambda x: title.lower() in x, dirs): # ["normal\\playground"]: #["derelict-restapi"]: #["normal\\normal9"]: #["normal\\playground"]: #["expeditions\\expeditions12 omega"]: #["normal\\normal8 omega"]: #['derelict-restapi']: #["normal\\normal9"]: #["expeditions\\expeditions9 utopia"]:  #dirs: #['orbital']: #["expeditions\\expeditions10 sigularity"]: #["normal\\normal8 orbital"]: 
